...
# https://oidc.eks.us-west-2.amazonaws.com/id/OIDC_ID
  ...
  "Statement": [
    {
      "Effect": "Allow",
      "Principal": {
        "Federated": "arn:aws:iam::${AWS_ACCOUNT_ID}:oidc-provider/oidc.eks.us-west-2.amazonaws.com/id/OIDC_ID"
      },
  ...
  "Statement": [
    {
      ...
      "Resource": ["arn:aws:kms:us-west-2:YOUR_AWS_ACCOUNT:key/CMK_KEY_HASH"],
      "Condition": {
        "Bool": {
