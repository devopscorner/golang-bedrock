...
# --------------------------------------------------------------------------
variable "aws_region" {
  description = "The AWS region to deploy the EKS certificate in"
  type        = string
  default     = "us-west-2"
}

variable "aws_account_id" {
  description = "The AWS Account ID to deploy the EKS certificate in"
  type        = string
  default     = "YOUR_AWS_ACCOUNT"
}

variable "aws_account_profile" {
  description = "The AWS Profile to deploy the EKS certificate in"
  type        = string
