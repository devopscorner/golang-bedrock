...
ENV AMAZON_BEDROCK_AGENT_ID=${AMAZON_BEDROCK_AGENT_ID:-YOUR_AMAZON_BEDROCK_AGENT_ID}
ENV AMAZON_BEDROCK_MODEL_ID=${AMAZON_BEDROCK_MODEL_ID:-anthropic.claude-3-haiku-20240307-v1:0}
ENV AMAZON_BEDROCK_VERSION=${AMAZON_BEDROCK_VERSION:-bedrock-2023-05-31}
...
ENV OTEL_RANDOM_THREAD_ACTIVE_UPPER_BOUND=${OTEL_RANDOM_THREAD_ACTIVE_UPPER_BOUND:-10}
